				...
				<div class="box-white">
                    ...
                    <div class="join-Form">
	                    <form action="" method="post">
							...
							<input type="email" class="input-style" name="farmEmail" placeholder="이메일" disabled>
							<input type="text" class="input-style" name="farmPhone" placeholder="전화번호"><br>
							<input type="text" class="input-style-plusbtn" name="farmAddressMain" placeholder="주소">
