	...
	<div class="contentForm">
		<div class="contentwrap">
			...
			<form action="/season/SeasonWrite.do" id="textWrite" method="post">
				...
				<%-- 글 제목 입력 --%>
				<input type="text" class="title" name="SeasonProductTitle" placeholder="제목을 입력하시오"/>
				
				<%-- 글 제목 입력 --%>
				<div class="contextForm">
					<textarea class="content" name="SeasonProductContent" placeholder="내용을 입력하시오"></textarea>
				</div>
