...
<div id="wrapForm" align="center">
	...
	<div class="contentForm">
		<div class="contentwrap">
			...
			<form action='/question/questionFarmWrite.do' method="post">
			<input type="hidden" name="farmNo" value="${farm.farmNo }">
				...
				<%-- 글 제목 입력 --%>
				<input type="text" class="title" name="questionFarmTitle" placeholder="제목을 입력하시오"/>
				
				<%-- 글 제목 입력 --%>
				<div class="contextForm">
					<textarea class="content" name="questionFarmContent" placeholder="내용을 입력하시오" style="resize: none;" ></textarea>
				</div>
